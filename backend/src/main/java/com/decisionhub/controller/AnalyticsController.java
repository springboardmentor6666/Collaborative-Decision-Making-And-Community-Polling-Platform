...
public class AnalyticsController {
    ...
    @Operation(summary = "Get community analytics")
    public ResponseEntity<ApiResponse<Map<String, Object>>> getCommunityAnalytics(@PathVariable Long communityId) {
        Map<String, Object> stats = analyticsService.getCommunityAnalytics(communityId);
        return ResponseEntity.ok(ApiResponse.success(stats));
    }
