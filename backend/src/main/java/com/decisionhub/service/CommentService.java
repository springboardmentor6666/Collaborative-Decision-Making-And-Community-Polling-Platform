...
public class CommentService {
    ...
    public CommentResponse createComment(CommentRequest request, String userEmail) {
        ...
        if (decision.getOwner() != null && !decision.getOwner().getId().equals(author.getId()) && eventPublisher != null) {
    ...
    public CommentResponse replyToComment(Long parentId, CommentRequest request, String userEmail) {
        ...
        if (parentComment.getAuthor() != null && !parentComment.getAuthor().getId().equals(author.getId()) && eventPublisher != null) {
