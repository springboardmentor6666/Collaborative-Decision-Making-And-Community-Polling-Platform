    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/analytics/overview").permitAll()
                .requestMatchers("/api/analytics/**").hasAnyRole("USER", "MODERATOR", "ADMIN")
                .requestMatchers("/api/notifications/**").hasAnyRole("USER", "MODERATOR", "ADMIN")
                .requestMatchers("/api/reports/**").hasAnyRole("USER", "MODERATOR", "ADMIN")
