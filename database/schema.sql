...
CREATE FULLTEXT INDEX ft_decisions_title_desc ON decisions (title, description);
CREATE FULLTEXT INDEX ft_communities_name_desc ON communities (name, description);
