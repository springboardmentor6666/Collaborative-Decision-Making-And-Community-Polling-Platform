...
function Login() {
  ...
  const fullText = "Centralize your intelligence. Connect the data points to make the right choices faster.";
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (response.ok && result.token) {
        ...
        // Give the success toast enough time to be seen before navigating
        setTimeout(() => {
          navigate("/home");
        }, 1500);
      } else {
        ...
        <div className="relative w-full max-w-[440px] group">
          ...
          <div className="relative bg-slate-900/60 backdrop-blur-2xl border border-white/10 rounded-[2rem] p-8 sm:p-10 shadow-2xl">
            ...
            <div className="text-center mb-8">
              <div className="w-16 h-16 mx-auto bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center text-3xl shadow-lg shadow-blue-500/20 border border-white/20 mb-4 rotate-3 hover:rotate-12 hover:scale-110 transition-all duration-300">🗳️</div>
              <h2 className="text-3xl font-bold text-white mb-2 tracking-wide">Welcome Back</h2>
              <p className="text-gray-400 font-medium text-sm">Sign in to access your dashboard</p>
            </div>
            ...
            <div className="space-y-5">
              ...
              <button 
                ...
                className={`w-full mt-2 flex items-center justify-center gap-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold py-4 px-4 rounded-xl shadow-[0_0_15px_rgba(37,99,235,0.4)] transition-all duration-300 overflow-hidden relative
                  ${isLoading ? 'opacity-75 cursor-not-allowed' : 'hover:shadow-[0_0_25px_rgba(147,51,234,0.6)] active:scale-[0.98] hover:-translate-y-1'}`}
              >
                ...
                {isLoading ? (
                  <>
                    {/* Inline CSS Spinner */}
                    <svg className="animate-spin h-5 w-5 text-white z-10" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
              ...
              <div className="text-center mt-6 pt-5 border-t border-white/10">
                ...
                <Link to="/signup" className="text-blue-400 font-semibold hover:text-purple-400 hover:underline transition-colors duration-300">Create Account</Link>
              </div>
            </div>
          </div>
        </div>
