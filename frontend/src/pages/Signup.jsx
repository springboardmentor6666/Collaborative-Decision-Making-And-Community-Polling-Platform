...
function Signup() {
  ...
  const fullText =
    "Join DecisionHub today. Empower your workflow with intelligent data connections.";
  ...
  const handleSignup = async () => {
    ...
    if (!hasMinLength || !hasLetter || !hasNumber || !hasSymbol) {
      setIsError(true);
      setMessage(
        "Password must contain digits, chars, symbols with len >= 8"
      );
      return;
    }
        ...
        <div className="relative w-full max-w-[460px] group">
          ...
          <div className="relative bg-slate-900/60 backdrop-blur-2xl border border-white/10 rounded-[2rem] p-7 sm:p-9 shadow-2xl">
            ...
            <div className="text-center mb-5">
              <div className="w-14 h-14 mx-auto bg-gradient-to-br from-blue-500 to-purple-600 rounded-xl flex items-center justify-center text-2xl shadow-lg shadow-blue-500/20 border border-white/20 mb-2.5 rotate-3 hover:rotate-12 hover:scale-110 transition-all duration-300">
                🚀
              </div>
            ...
            <div className="space-y-4">
              ...
              {/* Conditional Password Warning */}
              {isPasswordInvalid && (
                <p className="text-[11px] text-red-400 pl-1 -mt-2">
                  Password should contain digits, chars, symbols with len
                  &gt;= 8
                </p>
              )}
                ...
                className={`w-full mt-2 flex items-center justify-center gap-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold py-3.5 px-4 rounded-xl text-sm shadow-[0_0_15px_rgba(37,99,235,0.4)] transition-all duration-300 overflow-hidden relative
                  ${
                    isLoading
                      ...
                      : "hover:shadow-[0_0_25px_rgba(147,51,234,0.6)] active:scale-[0.98] hover:-translate-y-0.5"
                  }`}
              >
                ...
                {isLoading ? (
                  <>
                    <svg
                      className="animate-spin h-4 w-4 text-white z-10"
