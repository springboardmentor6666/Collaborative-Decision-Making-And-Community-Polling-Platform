...
public class ReportServiceImpl implements ReportService {
    ...
    @Override
    @Transactional
    public ReportResponse generatePdfReport(Long decisionId, Long requestingUserId) {
    ...
    @Override
    @Transactional
    public ReportResponse generateExcelReport(Long decisionId, Long requestingUserId) {
        Decision decision = decisionRepository.findById(decisionId)
                .orElseThrow(() -> new EntityNotFoundException("Decision", "id", decisionId));
        User requester = userIdOrNull(requestingUserId);
